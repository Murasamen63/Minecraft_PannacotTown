...
# page
    ## 1行目
        #item replace entity @s container.0 with fishing_rod{display:{Name:'[{"text":"Treasure Pond Fishing","color":"aqua","bold":true,"italic":false}]'},PCTWItems:1b,PCTWMasterGUIButton:1b,PCTWMasterGUIGameMode1:1b,Enchantments:[{}]} 1
        #item replace entity @s container.1 with wolf_spawn_egg{display:{Name:'[{"text":"人狼","color":"red","bold":true,"italic":false}]'},PCTWItems:1b,PCTWMasterGUIButton:1b,PCTWMasterGUIGameMode2:1b,Enchantments:[{}]} 1
