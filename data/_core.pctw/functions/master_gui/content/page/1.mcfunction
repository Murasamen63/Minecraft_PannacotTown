...
# page
    ## 1行目
        item replace entity @s container.0 with fishing_rod{display:{Name:'[{"text":"釣り大会","color":"aqua","bold":true,"italic":false}]'},PCTWItems:1b,PCTWMasterGUIButton:1b,PCTWMasterGUIGameMode1:1b,Enchantments:[{}]} 1
