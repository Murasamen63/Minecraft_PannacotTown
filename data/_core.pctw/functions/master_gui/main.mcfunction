...
# トロッコ召喚
    execute if entity @s[tag=!PCTW.Player.Use_MasterGUI] anchored eyes positioned ^ ^-0.2 ^ run summon minecraft:chest_minecart ~ ~ ~ {CustomName:'{"text":"スタロー"}',Tags:["PCTW.Minecart.MasterGUI","PCTW.Minecart.MasterGUI.Summon","PCTW.Minecart.Set.Done"],Silent:1b,CustomDisplayTile:1b,DisplayState:{Name:"minecraft:air"},NoGravity:1b}
