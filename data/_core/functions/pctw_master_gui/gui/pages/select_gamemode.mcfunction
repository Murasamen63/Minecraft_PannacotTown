#> _core:pctw_master_gui/gui/pages/select_gamemode
#
...
# インベントリ内容
    ## 1行目
        ### 釣り大会に変更
            item replace entity @s enderchest.0 with fishing_rod{display:{Name:'[{"text":"ゲームモード：","color":"white","italic":false},{"text":"釣り大会","color":"aqua","bold":true,"italic":false,"underlined":true}]'},PCTWItems:1b,PCTWMasterGUISwitches:1b,PCTWMasterGUIChangeFSBT:1b,Enchantments:[{}]} 1
