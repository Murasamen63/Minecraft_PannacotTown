...
#
# _core：MasterGUIのボタン「釣り大会/ゲームスタート」
#
# @within advancement _core:master_gui/fishing_battle/top/game_start
...
# GUI操作
    ...
    ## インベントリ削除
        function _core:pctw_master_gui/delete

# advancement削除
    advancement revoke @s only _core:master_gui/fishing_battle/top/game_start
