...
# 使用
    execute if score @s PCTW.Core.Use.WFoaS matches 1.. anchored eyes positioned ^ ^ ^2 align xyz if block ~ ~ ~ air unless entity @e[type=area_effect_cloud,tag=PCTW.AEC.MasterGUI.Summoned_Place,distance=..0.3] at @s run function _core:pctw_master_stick/summon_master_gui
