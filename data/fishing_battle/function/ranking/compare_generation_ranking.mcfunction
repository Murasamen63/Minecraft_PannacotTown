...
# 再帰処理
    ...
    ## 終了処理
        ### ランキング反映
            ...
            #### 2位
                execute if score $PCTW.FSBT.Temp.Compare.Count PCTW.Core.Temp matches 4 run data merge block 2 2 28 {front_text:{messages:["{\"text\":\"2位\",\"bold\":true,\"underlined\":true,\"color\":\"gray\"}","[\"\"]","{\"nbt\":\"Ranking.2.Name\",\"storage\":\"pctw:fishing_battle/ranking\"}","[\"\",{\"nbt\":\"Ranking.2.Score\",\"storage\":\"pctw:fishing_battle/ranking\",\"bold\":true},{\"text\":\"pt\",\"bold\":true}]"]},GlowingText:1b}
            #### 3位
