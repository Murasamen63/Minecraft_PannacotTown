#> fishing_battle:advancements/picked_up/high_class/takoyaki
#
# fishing_battle：『タコ焼き』を拾った時のadvancementのリワードfunction
#
# @within advancement fishing_battle:picked_up/high_class/takoyaki
...
# アイテム処理
        ...
        ### 観賞用アイテム付与
            execute if predicate fishing_battle:game_state/play run function fishing_battle:give/hooked_item/high_class/takoyaki
        ### 通知
            ### 通知
...
# advancement削除
    advancement revoke @s only fishing_battle:picked_up/high_class/takoyaki
