#> fishing_battle:give/hooked_item/high_class/hamburg_sushi
#
# fishing_battle：アイテムを付与『ハンバーグ寿司』
#
# @within function fishing_battle:advancements/picked_up/high_class/hamburg_sushi
