#> fishing_battle:give/hooked_item/high_class/shioramyon
#
# fishing_battle：アイテムを付与『塩らみょん』
#
# @within function fishing_battle:advancements/picked_up/high_class/shioramyon
